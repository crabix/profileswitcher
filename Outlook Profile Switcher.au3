...
GUICtrlSetData(-1,"Deutsch",IniRead($IniFile, "General", "Language", "English"))
...
While 1
	...
	if $msg[0] = $OptLang Then
		...
		if GuiCtrlRead($OptLang)="English" then
			$lang =1
		elseif GuiCtrlRead($OptLang)="Deutsch"then
			$lang = 2
		EndIf
		UpdateLang()
	EndIf
	...
	EndIf
		...
		If $Outlookrunning = "1" Then
			if GuiCtrlRead($List) <> $LastProfile Then
				...
				OutlookClose()
				;MsgBox(16,"profile",$a,5)
				;Sleep(1000)
				;MsgBox(16,"Closing OL","Closing Outlook",5)
				run($a)
...
Func SetLang()
	...
	$LangDispOpt[2]="Optionen"
	$LangDispSwitch[1]="Switch"
	$LangDispSwitch[2]="Wechseln"
	$LangOptDefProf[1]="Set as default profile"
	$LangOptDefProf[2]="Standardprofil setzen"
	$LangStat[1]="Wait, switching profile..."
	$LangStat[2]="Moment, wechsle das profile..."
	$LangQuit[1]="Do you really want to quit this program?"
	$LangQuit[2]="Willst Du wirklich das Programm beenden?"
	$LangLoaded[1]="Profile already active!"
	$LangLoaded[2]="Profil bereits aktiv"
	$LangLang[1]="Language:"
	$LangLang[2]="Sprache:"

	$LangOptAutoStart[1]="Startup with windows"
	$LangOptAutoStart[2]="mit Windows starten"
	$LangOptAutoSwitch[1]="Automatic switch"
	$LangOptAutoSwitch[2]="Automatisch wechseln"
